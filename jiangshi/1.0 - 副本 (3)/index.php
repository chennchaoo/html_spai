...
<script>
    ...
    <script>
        ...
        (function() {
            ...
            hm.src = "//hm.baidu.com/hm.js?c6e6bcf6690cae86352cc97cde1fc75c";
...
<script>
    $(document).ready(function(){
        ...
        $(".bg_3_1").click(function(){
            location.href='http://www.runforyourlives.com.cn/shanghai.html';
            //alert('跳转到报名链接，暂时木有');
        })
...
<script>
    ...
    var shareTitle='生存者OR感染者';
    var shareContent='一大波感染者正在来袭，你，准备好了么？';
