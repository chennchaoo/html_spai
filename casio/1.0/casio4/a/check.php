...
<div class="bg_2">
    ...
    <div class="check_title"><a href="http://m.v.qq.com/play/play.html?coverid=&vid=n0191trulr1">点这里！了解更多TR600 的功能</a></div>
    ...
    <div class="bg_2_1">
    	<div class="bg_2_1_left" onClick="left_img()"><img src="" id="img_1" alt="加载中..."></div>
    ...
    <div class="bg_2_3">
    	<div class="bg_2_dram_1">
        	<!--<div class="bg_2_dram_1_left" id="yuan_1">愿望：<span></span></div>-->
            
        </div>
        <div class="bg_2_dram_1">
        	<!--<div class="bg_2_dram_1_left" id="yuan_2">愿望：<span></span></div>-->
        </div>
    </div>
    <div class="check_woye">
    	<a href="enroll.php">我也要做最美桃花眼</a>
    </div>
    <div class="toupiao" onClick="return toupiao()"><a href="javascript:void(0)">为她投票，再来一组！</a></div>
