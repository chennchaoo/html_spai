...
function baoming(){
	...
	$.ajax({
		type:"POST",
		url: 'http://api20.taskou.com/c/casio4/add.php',
		dataType: 'json',
		data:'phone='+phone+'&truename='+name+'&address='+address+'&tag='+tag+'&imgs='+imgs+'&school='+school,
		success:function(data){
			if(data.code==1){
				alert('报名成功');
			}else{
...
<div class="bg_enroll" style="display:block">
    ...
    <!--<div class="en_bq">
    	<div class="en_bq_1" id="bq_1" onClick="yuanwang(1)"></div>
        <div class="en_bq_1" id="bq_2" onClick="yuanwang(2)"></div>
        <div class="en_bq_1" id="bq_3" onClick="yuanwang(3)"></div>
        <div class="en_bq_1" id="bq_4" onClick="yuanwang(4)"></div>
    </div>-->
    <div class="en_img">
    	<div class="en_img_1" id="shang_1" onClick="shangchuan(1)"><img src="img/bg_2_shang.jpg"></div>
        <div class="en_img_1" id="shang_2" onClick="shangchuan(2)"><img src="img/bg_2_shang.jpg"></div>
       <!-- <div class="en_img_1" id="shang_3" onClick="shangchuan(3)"><img src="img/shangchuan.png"></div>-->
    </div>
    <div class="en_input">
    	<div class="en_input_1"><input type="text" placeholder="点击填写姓名" id="name"></div>
        <div class="en_input_1"><input type="text" placeholder="点击填写联系电话" id="phone"></div>
        <div class="en_input_1"><input type="text" placeholder="点击填写学校" id="school"></div>
        <div class="en_input_1"><input type="text" placeholder="点击填写地址" id="address"></div>
