...
<div class="bg_1">
    ...
    <div class="erwei"  id="erwei" onClick="CloseDiv('overlay-bg2','erwei')" style="display:block">
    	
    <img src="img/erweima.png"></a>
    </div>
...
5.卡西欧（中国）贸易有限公司及上海羲岳网络科技有限公司、上海市时至广告有限公司有权在中国法律法规允许的范围内修改本活动条款及细则，并于《后生》手机平台或其他相关渠道公告后生效，敬请活动参与者留意。
    ...
    <div id="overlay-bg2" style="display:block" class="overlay-bg"onClick="CloseDiv('overlay-bg2','erwei')"></div>
